...
class TestGrafanaLokiAdapter(unittest.TestCase):
    ...
    def test_generate_logql_query_labels_only(self):
        ...
        self.assertEqual(
            result,
            '{organization_uuid="org-123", service_name="svc", action="create", crud="c"}',
        )
    ...
    def test_generate_logql_query_pipeline_only(self):
        ...
        self.assertEqual(
            result,
            '{} | source_ip="1.2.3.4" | target_id="tgt-1" | group_name="admins" | description="desc"',
        )
    ...
    def test_generate_logql_query_labels_and_pipeline(self):
        ...
        self.assertEqual(
            result,
            '{organization_uuid="org-123", service_name="svc"} | source_ip="1.2.3.4" | description="desc"',
        )
    ...
    def test_generate_logql_query_all_fields(self):
        ...
        self.assertEqual(
            result,
            '{organization_uuid="org-123", vrm_vendor_id="vendor-1", service_name="svc", action="update", actor_name="alice", target_name="bob", crud="u"} | source_ip="1.2.3.4" | target_id="tgt-1" | target_type="user" | group_id="grp-1" | group_name="admins" | description="desc"',
        )
